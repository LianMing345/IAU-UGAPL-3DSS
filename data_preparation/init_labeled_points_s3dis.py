...
root = '/data1/jy/data/s3dis/'
# save_path = '/data1/yb/code/HPAL-ICME-50/HPAL+TS-inconsistency-trainweight/data_preparation/init/s3dis/seed0_random_4ptsperpc.json'
save_path = '/data1/jy/all_points.json'
...
for area in ['Area_1', 'Area_2', 'Area_3', 'Area_4', 'Area_6']:
    ...
    for name in file_names:
        ...
        labeled_num_cur_pc = round(len(xyz) * 1) # 0.0002
        # labeled_num_cur_pc = 10
